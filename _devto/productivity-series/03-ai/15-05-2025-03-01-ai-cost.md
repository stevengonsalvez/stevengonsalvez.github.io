...
| **Gemini APIs**          | Generous Free Tier 🥇🗝️        | Backend for agentic tools, APIs   | 1M+ tokens             | API (for tools)          | N/A          | Gemini SOTA models           | Cheat code unlocked 📚                  | BYO-API     | Need to integrate API yourself         | 🗝️⚡               |
| **Google Code Assist**   | Free, 180k lines/day 💸       | Autocomplete, PR reviews          | N/A                    | Single purposed agent                | No           | Gemini/Google models          | Trivia in PRs!                          | adds PR trivia             | No customisation, github only               | 💸                 |
| **Copilot (Free)**       | Free, 2k completions, 50/mo   | Sampling Copilot                  | Limited                | Augmented (low)          | No           | GPT on the free                   | “Costco sausage sample”                 | “Just enough to taste, not enough to code”             | Very limited, instant paywall           | 😅                 |
| **Copilot Pro**          | £8/mo (~$10), 300/mo 🥇        | Voice coding, VSCode warriors     | Low (~8k tokens)                    | Augmented/Agentic (med)  | Rudimentary  | Most SOTA models       | MCP “auto-detect” superpower            | Voice chat that actually works                            | Agentic use is just fair(becoming better)              | 🥇                 |
| **Cursor**               | £15/mo, 500/mo, slow after 🔥  | IDE agentic power-users           | ~10k tokens    (has a max mode to support models limit)       | Agentic (high) 🤖        | Yes          | GPT-4, Claude, etc.           | Over-explains, “cascade”                | “Burns requests faster than a dev burns pizza”         | Slow/annoying after quota, pricey        | 🤖🔥              |
